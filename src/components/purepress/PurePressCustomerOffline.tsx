...
function updated(value: string) {
  ...
  return Number.isNaN(parsed.getTime()) ? value : parsed.toLocaleString("en-BW", { timeZone: "Africa/Gaborone", day: "numeric", month: "short", year: "numeric", hour: "2-digit", minute: "2-digit" });
}
