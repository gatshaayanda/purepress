import PurePressProductionDesk from "@/components/purepress/PurePressProductionDesk";
...
export default function PurePressStudioPage() {
  return <main id="main" className="pp-admin-page"><div className="pp-admin-container"><PurePressProductionDesk/><PurePressStudioDesk/><PurePressStudioQuotationOverview/><PurePressQuoteRequests/><PurePressStudioPrimer/></div></main>;
}
